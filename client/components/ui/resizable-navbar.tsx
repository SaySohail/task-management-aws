  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        // base: transparent; glass when visible:
        visible
          ? "bg-white/10 dark:bg-black/10 backdrop-saturate-150 border border-white/20 dark:border-white/10 supports-[backdrop-filter]:backdrop-blur-md"
          : "bg-transparent",
        className
      )}
    >
...
/** UPDATED: accepts href/onClick so you don't wrap it in another <a>.
 *  Avoids nested anchors that cause hydration errors.
 */
  ...
  return (
    ...
    >
      ...
      /> :  <img
        ...
        height={30}
      /> }
      <span className="font-medium">TrustByte</span>
    </a>
  );
};
