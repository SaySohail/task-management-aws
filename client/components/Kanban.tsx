...
const Kanban = () => {
  ...
  const columns = [
    { id: "To Do", title: "To Do", accent: "border-indigo-300/30" },
    { id: "In Progress", title: "In Progress", accent: "border-blue-500/30" },
    { id: "Completed", title: "Completed", accent: "border-violet-200/30" },
  ];
